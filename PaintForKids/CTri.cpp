...
void CTri::Save(ofstream& file, int ID, Output* pOut)
{
	file << "Triangle" << ID << " " << vertex1.x << " " << vertex1.y << " " << vertex2.x << " " << vertex2.y << " " << vertex3.x << " " << vertex3.y << " " << pOut->ColorToNames(FigGfxInfo.DrawClr);
